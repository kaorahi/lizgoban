...
1. Prepare engines (Leela Zero and/or KataGo) by yourself.
2. Download and extract the same all-in-one package as above.
3. Write your config.json. See [Project Home](https://github.com/kaorahi/lizgoban) for a sample of it.
4. Put config.json into the same folder as LizGoban*.exe.
