...
function create_leelaz () {
    ...
    // const humansl_delay_millisec = 20
    ...
    let on_ready = () => {
        ...
        const checks_without_startup_log = [  // avoid too long log
            ...
            // ['humansl', 'hs-best-moves-for-metas {}'],
    ...
    const update = () => arg && start_analysis()
    ...
    const send_to_queue = task => {
        ...
        // duplicated humansl
        humansl_command_p(task) && remove(humansl_command_p)
        // obsolete humansl / peek
        changer_command_p(task) && [humansl_command_p, peek_command_p].forEach(remove)
