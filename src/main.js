...
function menu_template(win) {
    ...
    const tool_menu = menu('Tool', [
        ...
        menu('Tsumego frame', [
            ...
            item("ko", 'CmdOrCtrl+Shift+f',
                 () => add_tsumego_frame(true), true, game.move_count > 0),
            item("(without ko threats)", null,
                 () => add_tsumego_frame('no_ko_threat'), true, game.move_count > 0),
        ]),
        sep,
        item('Clear analysis', undefined, P.delete_cache),
        item('...Restore analysis', undefined, P.undelete_cache),
        sep,
        item('Tag / Untag', 'Ctrl+Space', tag_or_untag),
        menu('Plot MCTS tree', [
            item('Normal', 'CmdOrCtrl+Shift+T', () => plot_mcts_force_actual(0.0), true, AI.katago_p()),
            item('Prefer played moves', 'CmdOrCtrl+T', () => plot_mcts_force_actual(0.3), true, AI.katago_p()),
        ]),
